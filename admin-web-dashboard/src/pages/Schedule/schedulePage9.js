...
class SchedulePage9 extends Component {
    render() {
        return (
            <div>
                <div id="route_container">
                    ...
                    <Link to={'/Schedule_9'} class="database_route selected">Level 9</Link>
                    <Link to={'/Schedule_10'} class="database_route">Level 10</Link>
                </div>
                <TimelineResource level="C" />
            </div>
        )
    }
}

export default SchedulePage9